...
clear
global PATH "/Users/menruoyu/Downloads/124861-V1/"
...
merge 1:1 unitid year using institutionmaster1_2019.dta
drop if _merge!=3
drop _merge
...
sort unitid year
merge 1:1 unitid year using gradmaster1_2019.dta
...
sort unitid year
merge 1:1 unitid year using revenuesmaster1_2019.dta
drop if _merge==2
drop _merge
...
sort unitid year
merge 1:1 unitid year using facultymaster1_2019.dta
drop if _merge==2
drop _merge
sort unitid year
merge 1:1 unitid year using tuitionmaster1_2019.dta
drop if _merge==2
drop _merge
